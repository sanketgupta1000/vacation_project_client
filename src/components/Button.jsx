...
function Button({
  ...
  const colorVariants = {
    ...
    black: "bg-gray-900 text-white hover:bg-gray-700 focus:ring-blue-500",
  };

  const classNameToApply = noClass
    ? className
    : `${colorVariants[color]} px-6 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform   focus:outline-none focus:ring focus:ring-opacity-80 ${className}`;
