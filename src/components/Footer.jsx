...
function Footer()
{
    ...
    <div className="container p-6 mx-auto 
        ...
        <div className="lg:flex ">
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div>
                        <h3 className="text-gray-700 uppercase dark:text-white">Want to</h3>
                        <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">See books</a>
                        <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Upload book</a>
                        <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">be member</a>
                    </div>

                    {/* what should be here */}
                    <div>
                        <h3 className="text-gray-700 uppercase dark:text-white"></h3>
        ...
        <div>
            <p className="text-center text-gray-500 dark:text-gray-400">© [our website name] - All rights reserved</p>
        </div>
    </div>
</footer>
    );
