...
function BookCard({
  ...
  <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3"> */}
    ...
    <p className="font-com text-2xl font-semibold text-white">All Images are from <a href="https://unsplash.com" className="text-blue-500">Unsplash.com</a></p>
                ...
                {/* new card end */}
                {/* <div className="mt-9 w-[275px] h-[421px] mx-auto rounded-md border hover:bg-gray-100 hover:shadow-md hover:shadow-black" >
  <img
...
//    src="https://images.unsplash.com/photo-1522199755839-a2bacb67c546?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fGJsb2d8ZW58MHx8MHx8&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=60"
    alt="Laptop"
    className="h-[200px] mt-3 w-full rounded-md object-contain"
  />
  <div className="p-2 justify-between ">
    <h1 className="text-xl font-bold font-serif text-red-500" >{book.bookTitle}</h1>
    <p className="mt-3 text-sm text-gray-600">
      By 
      <p className="mt-0.5 text-sm ml-2 text-gray-800">
    {book.bookAuthor}
    </p>
    </p>
 ...
 */}
                ...
                {/* <div className="relative h-[400px] w-[300px] hover:bg-slate-100 shadow-sm shadow-gray-400 dark:bg-gray-800">
  <img
  ...
  <div className="absolute bottom-4 left-4 text-left"> */}
                {/* <h1 className="text-lg font-semibold text-white">{book.bookTitle}</h1>
    <p className="flex pr-2 mt-2 pl-4 text-gray-600 dark:text-gray-300">by 
    ...
    {book.bookAuthor}
                ...
                {/* <div className=" mt-5 mx-auto py-6 px-9 hover:bg-slate-100 hover:scale-105 bg-white  shadow-sm shadow-gray-400  dark:bg-gray-800 "> */}
        ...
        {/* <a className="px-3 py-1 text-sm font-bold text-gray-100 transition-colors duration-300 transform bg-gray-600 rounded cursor-pointer hover:bg-gray-500" tabindex="0" role="button">Design</a> */}
                ...
                {/* <div className="mt-1"> */}
                {/* <p className="text-2xl font-serif font-extrabold text-red-700 dark:text-white  dark:hover:text-gray-200" >{book.bookTitle}</p>
        <p className="flex pr-2 mt-2 pl-4 text-gray-600 dark:text-gray-300">by 
